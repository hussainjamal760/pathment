...
import {
  ClipboardCheck, Flag, Clock, TrendingUp, TrendingDown, Minus, ArrowUpRight, Users2, ListPlus, Inbox, Sparkles } from 'lucide-react';
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            {m.isNew && (
              <span title={m.daysSinceJoined != null ? `Joined ${m.daysSinceJoined === 0 ? 'today' : `${m.daysSinceJoined}d ago`}` : 'New to the platform'}
                className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[11px] font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200 shrink-0">
