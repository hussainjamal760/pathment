...
const ROLES = {
  ...
  program_admin: {
    ...
    permissions: [
      ...
      P.TASK_ASSIGN, P.TASK_REVIEW, P.MENTEE_VIEW, P.MENTEE_MANAGE, P.MENTEE_TRANSFER,
  ...
  people_admin: {
    ...
    permissions: [P.USER_MANAGE, P.CLAN_CREATE, P.CLAN_MANAGE_MEMBERS, P.MENTEE_VIEW, P.MENTEE_MANAGE, P.MENTEE_TRANSFER]
  },
  moderator: {
    label: 'Moderator',
    scope: 'org',
